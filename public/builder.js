...
return [payload];`, x,y); }
  ...
  // ---------------- message composer (archetype-aware) ----------------
...
l.route = l.score>=60?'ae':'sdr'; return [l];`, -700,300);
  ...
  function buildWorkflowJSON(scenario, industry, opts = {}) {
    ...
    withYOffset(wf, 0, () => {
      addLaneHeader(wf, "PRODUCTION LANE", -1320, 40);
